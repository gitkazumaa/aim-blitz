...
import { FiveTargets } from "../three-components/FiveTargets"

// target radius: 0.125
const scenarioName = "1-wall-5-targets"

export const OneWallFiveTargetsPage = () => {
	return (
		<LocalSettingsProvider>
			<PointerLockProvider>
				<ChallengeProvider>
					<ScoreProvider damagePerHit={25}>
						<TimerProvider timeDuration={60} scenarioName={scenarioName}>
